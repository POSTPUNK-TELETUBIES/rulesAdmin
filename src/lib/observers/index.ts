...
export const [ activateFilterChange$, setActivateFilterChange ] = createSignal<string | null>()
export const [ useActiveFilter ] = bind(activateFilterChange$, null)


export const [ severityFilterChange$, setSeverityFilterChange ] = createSignal<string | boolean>()
